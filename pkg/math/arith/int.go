...
// IsInIntervalLEpsRootN returns true if n ∈ [-2ˡ'⁺ᵉ√N,…,2ˡ'⁺ᵉ√N], for a Paillier modulus N.
func IsInIntervalLEpsRootN(n *safenum.Int) bool {
	if n == nil {
		return false
	}
	return n.TrueLen() <= params.LPlusEpsilon+(params.BitsIntModN/2)
}
