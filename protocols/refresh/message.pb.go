...
type Refresh3 struct {
	...
	VSSSchnorrCommitments []github_com_taurusgroup_cmp_ecdsa_pkg_math_curve.Point `protobuf:"bytes,3,rep,name=VSSSchnorrCommitments,proto3,customtype=github.com/taurusgroup/cmp-ecdsa/pkg/math/curve.Point" json:"VSSSchnorrCommitments"`
...
type Refresh4 struct {
	...
	VSSSchnorrResponse []github_com_taurusgroup_cmp_ecdsa_pkg_math_curve.Scalar `protobuf:"bytes,4,rep,name=VSSSchnorrResponse,proto3,customtype=github.com/taurusgroup/cmp-ecdsa/pkg/math/curve.Scalar" json:"VSSSchnorrResponse"`
}
...
var fileDescriptor_9c6bcf991e71965e = []byte{
	...
	,
}
...
func (m *Refresh3) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.VSSSchnorrCommitments) > 0 {
		for iNdEx := len(m.VSSSchnorrCommitments) - 1; iNdEx >= 0; iNdEx-- {
			{
				size := m.VSSSchnorrCommitments[iNdEx].Size()
				i -= size
				if _, err := m.VSSSchnorrCommitments[iNdEx].MarshalTo(dAtA[i:]); err != nil {
					return 0, err
				}
				i = encodeVarintMessage(dAtA, i, uint64(size))
			}
...
func (m *Refresh4) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.VSSSchnorrResponse) > 0 {
		for iNdEx := len(m.VSSSchnorrResponse) - 1; iNdEx >= 0; iNdEx-- {
			{
				size := m.VSSSchnorrResponse[iNdEx].Size()
				i -= size
				if _, err := m.VSSSchnorrResponse[iNdEx].MarshalTo(dAtA[i:]); err != nil {
					return 0, err
				}
				i = encodeVarintMessage(dAtA, i, uint64(size))
			}
...
func (m *Refresh3) Size() (n int) {
	...
	if len(m.VSSSchnorrCommitments) > 0 {
		for _, e := range m.VSSSchnorrCommitments {
			l = e.Size()
			n += 1 + l + sovMessage(uint64(l))
		}
	}
...
func (m *Refresh4) Size() (n int) {
	...
	if len(m.VSSSchnorrResponse) > 0 {
		for _, e := range m.VSSSchnorrResponse {
			l = e.Size()
			n += 1 + l + sovMessage(uint64(l))
		}
	}
...
func (m *Refresh3) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VSSSchnorrCommitments", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.VSSSchnorrCommitments = append(m.VSSSchnorrCommitments, v)
			if err := m.VSSSchnorrCommitments[len(m.VSSSchnorrCommitments)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
...
func (m *Refresh4) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VSSSchnorrResponse", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.VSSSchnorrResponse = append(m.VSSSchnorrResponse, v)
			if err := m.VSSSchnorrResponse[len(m.VSSSchnorrResponse)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
